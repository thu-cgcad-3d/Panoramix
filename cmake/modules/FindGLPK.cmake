...
FIND_PATH(GLPK_INCLUDE_DIR
  glpk.h
  PATHS ${GLPK_REGKEY}/include /user/include /user/local/include /opt/local/include
  HINTS ${GLPK_ROOT_DIR}/include
)

IF (CMAKE_CL_64)
    SET (GLPK_LIBRARY_HINT ${GLPK_ROOT_DIR}/w64)
ELSE (CMAKE_CL_64)
    SET (GLPK_LIBRARY_HINT ${GLPK_ROOT_DIR}/w32)
ENDIF (CMAKE_CL_64)

FIND_LIBRARY(GLPK_LIBRARY
  glpk
  PATHS ${GLPK_REGKEY}/lib /use/lib /user/local/lib /opt/local/lib
  HINTS ${GLPK_ROOT_DIR}/lib ${GLPK_LIBRARY_HINT}
)
