...
//
            ...
            #define DEFINE_DATA_CATEGORY(checker, tag_name) \
            namespace detail { \
                struct category_tag {}; \
                template <class T> std::enable_if_t<(checker), tag_name> \
                category_tag_fun() { return tag_name(); } \
            }
            ...
            namespace detail {
                ...
                template <class T>
                struct category_tag {
                    using type = decltype(category_tag_fun<T>());
                };
                template <class T> using category_tag_t = typename category_tag<T>::type;
            }
