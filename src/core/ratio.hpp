...
namespace panoramix {
    namespace core {
        ...
        template <class T, class S>
        struct IsRatio<Ratio<T, S>> : std::true_type {};
        ...
        // ratio and ratio
        template <class T1, class S1, class T2, class S2>
        inline typename RatioOperationResult<T1, S1, T2, S2, Plus>::type operator + (
            const Ratio<T1, S1> & a, const Ratio<T2, S2> & b) {
            return MakeRatio(a.numerator * b.denominator + b.numerator * a.denominator, a.denominator * b.denominator);
        }
        template <class T1, class S1, class T2, class S2>
        inline typename RatioOperationResult<T1, S1, T2, S2, Minus>::type operator - (
            const Ratio<T1, S1> & a, const Ratio<T2, S2> & b) {
            return MakeRatio(a.numerator * b.denominator - b.numerator * a.denominator, a.denominator * b.denominator);
        }
        template <class T1, class S1, class T2, class S2>
        inline typename RatioOperationResult<T1, S1, T2, S2, Mult>::type operator * (
            const Ratio<T1, S1> & a, const Ratio<T2, S2> & b) {
            return MakeRatio(a.numerator * b.numerator, a.denominator * b.denominator);
        }
        template <class T1, class S1, class T2, class S2>
        inline typename RatioOperationResult<T1, S1, T2, S2, Div>::type operator / (
            const Ratio<T1, S1> & a, const Ratio<T2, S2> & b) {
        ...
        // ratio and scalar
        template <class T1, class S1, class T2, class = std::enable_if_t<!IsRatio<T2>::value>>
        inline typename RatioOperationResult<T1, S1, T2, S1, Plus>::type operator + (
            const Ratio<T1, S1> & a, const T2 & b) {
            return MakeRatio(a.numerator + b * a.denominator, a.denominator);
        }
        template <class T1, class S1, class T2, class = std::enable_if_t<!IsRatio<T2>::value>>
        inline typename RatioOperationResult<T1, S1, T2, S1, Minus>::type operator - (
            const Ratio<T1, S1> & a, const T2 & b) {
            return MakeRatio(a.numerator - b * a.denominator, a.denominator);
        }
        template <class T1, class S1, class T2, class = std::enable_if_t<!IsRatio<T2>::value>>
        inline typename RatioOperationResult<T1, S1, T2, S1, Mult>::type operator * (
            const Ratio<T1, S1> & a, const T2 & b) {
            return MakeRatio(a.numerator * b, a.denominator);
        }
        template <class T1, class S1, class T2, class = std::enable_if_t<!IsRatio<T2>::value>>
        inline typename RatioOperationResult<T1, S1, T2, S1, Div>::type operator / (
            const Ratio<T1, S1> & a, const T2 & b) {
        ...
        template <class T1, class S1, class T2, class = std::enable_if_t<!IsRatio<T2>::value>>
        inline bool operator < (const Ratio<T1, S1> & a, const T2 & b) {
            return a.denominator >= 0 ? (a.numerator < a.denominator * b) : (a.numerator > a.denominator * b);
        }
