...
Reconstruct(const Mesh<VertDataT, HalfDataT, FaceDataT> &mesh,
            const SubMesh &sub, PlaneObjectiveFunT planes2energy,
...
std::vector<SubMesh>
ExtractSubMeshes(const Mesh<VertDataT, HalfDataT, FaceDataT> &mesh,
                 HalfEdgeColinearFunT colinearFun, int drfTryNum) {
...
Reconstruct(const Mesh<VertDataT, HalfDataT, FaceDataT> &mesh,
            const SubMesh &sub, PlaneObjectiveFunT planes2energy,
            VertDataToDirectionFunT vert2dir, int drfSlack, int maxIters) {
