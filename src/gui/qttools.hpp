...
namespace panoramix {
    namespace gui {
        ...
        class UIWidget : public BaseWidgetT {
        public:
        ...
        private:
            void setupPens(const std::vector<PenConfig> & pc) {
                ...
                connect(defaultAction = bas->addAction(tr("Pick")), &QAction::triggered, [this]() { 
                    _activePenId = -1; 
                });
        ...
        public:
            ...
            QPen activePen() const { return _activePenId == -1 ? QPen() : _pens[_activePenId]; }
