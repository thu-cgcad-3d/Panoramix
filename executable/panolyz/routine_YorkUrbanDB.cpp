...
namespace panolyz {
    ...
    void Test(const std::string & name){
        ...
        if (1){
            ...
            gc = gcEstimator.postProcess(outdoor ? data.gcOutdoor : data.gcIndoor2, 
        ...
        if (1){
            int vertVPId = GetVerticalDirectionId(vps, view.camera.upward());
    ...
    ROUTINE_FOR_ALGORITHM(YorkUrbanDB){
